...
def main() -> int:
    ...
    fidelity = [
        (GT_NO_MISSING_CALLS, "required_calls_permitted"),
        (GT_NO_EXCESS_CALLS, "no_excess_calls_permitted"),
        (GT_EXACT_AUTHORIZATION, "exact_authorization"),
